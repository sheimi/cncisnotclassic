...
class Campus extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('campus_name, college_id', 'required'),
			array('campus_name', 'length', 'max'=>255),
			array('college_id', 'length', 'max'=>5),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('campus_id, campus_name, college_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('college_id',$this->college_id,true);
