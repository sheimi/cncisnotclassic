 ...
 * @property string $id
 */
class JwData extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return JwData the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('course_name, teacher', 'length', 'max'=>255),
			array('course_type, campus', 'length', 'max'=>45),
			array('site', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('course_id, grade, term, institute_id, course_name, course_type, credit, period, campus, teacher, site, id', 'safe', 'on'=>'search'),
		);
	}
